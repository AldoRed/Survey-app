            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
                <div
                    ...
                    class="
                        ...
                        "
                >
                    <img class="w-full h-48 object-cover" :src="survey.image" alt="">
                    <h3 class="mt-4 text-lg font-bold">{{ survey.title }}</h3>
                    <p class="overflow-hidden flex-1">{{ survey.description }}</p>

                    <!--Div that contains buttons to call to action (Edit and Delete)-->
